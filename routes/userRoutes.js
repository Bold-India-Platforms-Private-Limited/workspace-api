...
import { getMe, updateMobile, updateName, neverLoggedIn, getTeam, resetMemberPassword, sendLoginReminder } from "../controllers/userController.js";
...
userRouter.post("/send-login-reminder", sendLoginReminder); // admin: email never-logged-in users
